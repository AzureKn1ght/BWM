const abi = [
  {
    inputs: [
      { internalType: "address", name: "_climbToken", type: "address" },
  ...
  },
  {
    ...
    name: "CLIMB",
    outputs: [
      { internalType: "contract IOwnableClimb", name: "", type: "address" },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "eggsToClaim", type: "uint256" },
